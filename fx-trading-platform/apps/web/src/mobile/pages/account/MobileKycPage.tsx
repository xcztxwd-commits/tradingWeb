...
export function MobileKycPage({ model }: { model: AccountRouteModel }) {
  return <div className={styles.root} data-platform-view="mobile"><MobileAccountPageFrame model={model} expectedMode="kyc" /></div>
}
