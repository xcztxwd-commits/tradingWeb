import { SimplifiedLiquidationDisclaimer } from '../order-form/SimplifiedLiquidationDisclaimer'
import { TradingSettingsBar } from '../order-form/TradingSettingsBar'
...
import styles from '../order-form/TradingControls.module.css'
